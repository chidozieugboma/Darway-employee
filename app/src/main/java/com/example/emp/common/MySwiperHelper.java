...
import com.example.emp.Callback.MyButtonClickListener;
...
public abstract class MySwiperHelper extends ItemTouchHelper.SimpleCallback {
    ...
    protected MySwiperHelper(Context context, RecyclerView recyclerView, int buttonWidth){
    ...
    public class MyButton {
        ...
        private void onDraw(Canvas c, RectF rectF, int pos){
            ...
            float x,y;
            if(imageResId ==0){ //if this show text
